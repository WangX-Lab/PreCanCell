...
output:
  ...
  BiocStyle::html_document:
    ...
    collapse: yes
vignette: |
  %\VignetteIndexEntry{PreCanCell_introduction} %\VignetteEngine{knitr::rmarkdown} %\VignetteEncoding{UTF-8}
---
...
```{r, echo = FALSE}
knitr::include_graphics("~/PreCanCell/vignettes/PreCanCell_overview.png")
```
